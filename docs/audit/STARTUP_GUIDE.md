...
DATABASE_PORT=5432
DATABASE_NAME=blueprint_builder
...
createdb blueprint_builder

# Or using psql
psql -U postgres -c "CREATE DATABASE blueprint_builder;"
```
...
3. Ensure database exists: `psql -l | grep blueprint`
