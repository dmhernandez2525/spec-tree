...
import type { StrapiEpic, StrapiFeature, StrapiUserStory, StrapiTask } from '@/types/strapi';
...
describe('formatDBData', () => {
        ...
        epics: [
          {
            ...
            timeline: 'Q1 2024',
            resources: 'Dev team',
            risksAndMitigation: [{ resolve: [{ text: 'Resolve 1' }], own: [{ text: 'Own 1' }], accept: [{ text: 'Accept 1' }], mitigate: [{ text: 'Mitigate 1' }] }],
            notes: 'Epic notes',
            features: [],
            contextualQuestions: [],
        ...
        epics: [
          {
            ...
            notes: '',
            features: [
              { documentId: 'feature-1', title: 'F1', description: '', details: '', acceptanceCriteria: [], notes: '', userStories: [] } as unknown as StrapiFeature,
              { documentId: 'feature-2', title: 'F2', description: '', details: '', acceptanceCriteria: [], notes: '', userStories: [] } as unknown as StrapiFeature,
            ],
          } as unknown as StrapiEpic,
        ],
      },
  ...
  it('uses default values for optional feature fields', () => {
    ...
    // When acceptanceCriteria is empty array, it stays empty array (not replaced with default)
    expect(result.sow.features['feature-1'].acceptanceCriteria).toEqual([]);
  });
                ...
                userStories: [
                  {
                    ...
                    developmentOrder: 0,
                    tasks: [
                      { documentId: 'task-1', title: 'Task 1', details: '', priority: 0, notes: '' } as unknown as StrapiTask,
                      { documentId: 'task-2', title: 'Task 2', details: '', priority: 0, notes: '' } as unknown as StrapiTask,
                    ],
                  } as unknown as StrapiUserStory,
                ],
              } as unknown as StrapiFeature,
